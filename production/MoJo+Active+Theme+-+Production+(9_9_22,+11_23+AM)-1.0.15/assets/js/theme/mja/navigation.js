export default function navigation() {
  $(document).on('click', ".nav-primary  span.more, .nav-primary .nav-link.level-0, .nav-primary .float-to-right.active ul.level-1 a.nav-link:not('.shop-all-link')", function (e) {
